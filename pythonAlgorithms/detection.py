...
class Detection:
    ...
    def comparison(self, last_one:str, with_errors:str):
        errors = ""
    ...
    def fix_errors(self, parities:str):
        count = 0
        ...
        if count == 0:    
            ...
            if val == "0":
                ...
                y = "0"
            result = self.code_with_errors[:self.code_with_errors-1] + y + self.code_with_errors[error_pos:]
        else:
            p = self.to_decimal()
